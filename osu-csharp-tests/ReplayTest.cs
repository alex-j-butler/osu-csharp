...
namespace OsuAPI.ReplayParser.Tests
{
    ...
    public class ReplayTest
    {
        ...
        public void ParseReplay_Passcode()
        {
            ...
            DateTime Date = new DateTime(2016, 09, 12, 1, 16, 59, 239);
            ...
            Assert.AreEqual(Date.ToLongDateString(), replay.Date.ToLongDateString());
        ...
        public void ParseReplay_FallingInLove()
        {
            ...
            DateTime Date = new DateTime(2015, 07, 16, 07, 43, 59, 908);
        ...
        [TestMethod]
        public void CalculateAccuracy100s()
        {
            int Count300 = 0;
            int Count100 = 530;
            int Count50 = 0;
            int CountMisses = 0;
            double ExpectedAcc = 33.33;

            Assert.AreEqual(ExpectedAcc, Replay.CalculateAccuracy(Count300, Count100, Count50, CountMisses));
        }

        [TestMethod]
        public void CalculateAccuracy50s()
        {
            int Count300 = 0;
            int Count100 = 0;
            int Count50 = 530;
            int CountMisses = 0;
            double ExpectedAcc = 16.67;
